...
import 'package:tvseries/data/models/tv_response.dart';
...
void main() {
  ...
  setUp(() {
    ...
    group('get On Air Tv', () {
      final tTvList = TvResponse.fromJson(json.decode(readJson('dummy_data/on_the_air.json')))
            .tvList;
      ...
      test('should throw a ServerException when the response code is 404 or other',() async {
        ...
        // arrange
        when(mockHttpClient.get(Uri.parse('$baseUrl/tv/on_the_air?$apiKey'))).thenAnswer((_)
    ...
    group('get on Popular TV', () {
      ...
      test('Return if list of tv when response is success (200)', () async {
        ...
        // arrange
        when(mockHttpClient.get(Uri.parse('$baseUrl/tv/popular?$apiKey'))).thenAnswer((_)
        async => http.Response(readJson('dummy_data/popular_tv.json'), 200));
    ...
    group('get the Top Rated Tv', () {
      final tTvList = TvResponse.fromJson(json.decode(readJson('dummy_data/top_rated_tv.json')))
          .tvList;

      test('should return list of tv when response code is 200 ', () async {

        // arrange
        when(mockHttpClient.get(Uri.parse('$baseUrl/tv/top_rated?$apiKey'))).thenAnswer((_)
        async => http.Response(readJson('dummy_data/top_rated_tv.json'), 200));
      ...
      test('Throw if ServerException when response code is other than 200',() async {
    ...
    group('get the tv detail', () {
      ...
      test('Return if movie detail when the response code is 200', () async {
        ...
        // arrange
        when(mockHttpClient.get(Uri.parse('$baseUrl/tv/$tId?$apiKey'))).thenAnswer((_)
            async => http.Response(readJson('dummy_data/tv_detail.json'), 200));
    ...
    group('get the tv recommendations', () {
      final tTvList = TvResponse.fromJson(json.decode(readJson('dummy_data/tv_recommendations.json')))
          .tvList;
      ...
      test('Throw if Server Exception when the response code is 404 or other',() async {
    ...
    group('search the tv', () {
      final tSearchResult = TvResponse.fromJson(json.decode(readJson('dummy_data/search_got_tv.json')))
          .tvList;
      ...
      test('Return if list of tv when response code is 200', () async {
        ...
        when(mockHttpClient.get(Uri.parse('$baseUrl/search/tv?$apiKey&query=$tQuery')))
            .thenAnswer((_) async => http.Response(readJson('dummy_data/search_got_tv.json'), 200));
